<template>
<div>
    <div class="container mt-3" v-if="!loading" :key="genre">
    ...
    <div class="container mt-3 loading" v-if="loading">
        <comix-loading-div class="title breadcrumbs mt-2"></comix-loading-div><br>
