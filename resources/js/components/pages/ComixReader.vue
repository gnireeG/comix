<template>
    <div>
        <div class="container">
            <div class="row image-row no-gutters" v-if="finishedLoadingComic && finishedLoadingImages">
            ...
            <div class="row mt-3" v-if="finishedLoadingComic && finishedLoadingImages">
                ...
                <div class="col-lg-6 text-align-center">
                    <span class="font-brand font-lg page-nr">
                        <span v-show="currentPage > 0">Seite {{ currentPage }} / {{ comicImages.length / 2 }}</span>
                ...
                <div class="col-lg-2 text-align-right" v-show="currentPage < comicImages.length / 2"><a class="button-primary font-brand font-lg" @click="nextPage">Nächste Seite</a></div>
            </div>
            <audio ref="pageturn">
